...
class InformacionSearch extends Informacion
{
    ...
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['foto', 'idestudiante', 'idcentro', 'idexamen'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'foto', $this->foto])
            ->andFilterWhere(['like', 'idestudiante', $this->idestudiante])
            ->andFilterWhere(['like', 'idcentro', $this->idcentro])
            ->andFilterWhere(['like', 'idexamen', $this->idexamen]);
